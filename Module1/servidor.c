...
int main(){
    ...
    //    disponível para receber outra mensagem. Esse processo
    //    acontece indefinidamente, desde que não receba a
    //    mensagem "/quit".
    //
    //    Caso receba a mensagem "/quit", a conexão será
    //    desfeita e o servidor será encerrado.
